                ...
                <table>
                    ...
                    <tr>
                        <td style="font-size:15px;">
                            <select style="width : 80px;font-size:15px;" id="zone" name="zone">
                            	<option>지역선택</option>
                        ...
                        <td style="display: flex; align-items: center;justify-content:center;">
                          <input type="checkbox" class="carType" name="car-type" value="소형" onclick="doOpenCheck(this);"> <span>소형</span> &nbsp;
                          <input type="checkbox" name="car-type" class="carType" value="중형" onclick="doOpenCheck(this);"> <span>중형</span> &nbsp;
                          <input type="checkbox" name="car-type" class="carType" value="대형" onclick="doOpenCheck(this);"> <span>대형</span>
                        </td>
                        <td style="width:20%;">
            ...
            <ul class="carlist">
                ...
                <li class="carList-li" data-point="<%=c.getCarRate() %>" data-price="<%= Integer.parseInt(c.getCarPrice())%>">
                    ...
                    <div style="text-align: justify;padding:10px;box-sizing: border-box;">
	                    ...
	                    <span class="gray" style="height:40px;line-height: 20px;"><%=c.getCarLocation() %></span>
                	</div>
                </li>
                </a>
                <%} %>
