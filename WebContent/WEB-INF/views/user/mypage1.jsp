				...
				<div class="content">
					<div class="contentTop">
						<div class="contentTRL">
							<h4>
								<span id="contentSpan">예약정보</span>
							</h4>

						</div>
						<div class="contentTRL">
							<h6 style="text-align: right;">
								홈>회원안내><span id="contentSpan2">예약정보</span>
							</h6>
						</div>
					</div>
...
<!--/////////////////////////////////////////////////////////////////////////////////////////  -->
					...
					<div class="contentBottom">
						...
						<button type="button" class="btn btn-info btn-lg"
							data-toggle="modal" data-target="#myModal">차량 등록</button>
							...
							<table class="table">
								<tr>
									...
									<td><input type="text" name="memberNo"
										class="form-control" value="<%=member.getUserNo()%>" readonly></td>
								</tr>
								<tr>
									<th>아이디</th>
								...
								<tr>
									<th>신고 횟수</th>
									<td><input type="text" name="report" class="form-control"
 ...
 %>
								...
								<tr>
									<th>가입일</th>
									<td><input type="text" name="enroll" class="form-control"
